...
<div style="display: flex; flex-wrap: wrap; gap: 12px">
  ...
  <div class="well" style="width: 240px">
      <h4 style="min-height: 80px"><a href="https://intenseminimalism.com/2020/nemawashi-a-key-leadership-skill-to-foster-a-healthy-work-environment/">Nemawashi: a key leadership skill to foster a healthy work environment</a></h4>
      <div><i class="icon icon-user"></i> Erin 'Folletto' Casali</div>
      <div><i class="icon icon-calendar"></i> 2020-03-30</div>
...
### Urgent vs Important
I would like to immediately recommend that you read [other people's words](https://todoist.com/productivity-methods/eisenhower-matrix) about the Eisenhower Matrix.
...
<div style="display: flex; flex-wrap: wrap; gap: 12px">
  <div class="well" style="width: 240px">
      <h4 style="min-height: 80px"><a href="https://martinfowler.com/articles/scaling-architecture-conversationally.html">Scaling the Practice of Architecture, Conversationally</a></h4>
      <div><i class="icon icon-user"></i> Andrew Harmel-Law</div>
      <div><i class="icon icon-calendar"></i> 2021-12-15</div>
  </div>
  <div class="well" style="width: 240px">
    <h4 style="min-height: 80px"><a href="https://cognitect.com/blog/2011/11/15/documenting-architecture-decisions.html">Documenting Architecture Decisions</a></h4>
    <div><i class="icon icon-user"></i> Michael Nygard</div>
    <div><i class="icon icon-calendar"></i> 2011-11-15</div>
  </div>
  <div class="well" style="width: 240px">
      <h4 style="min-height: 80px"><a href="https://xebia.com/blog/lean-architecture-principle-5-just-in-time-just-enough">Lean Architecture Principle #5: Just in time, just enough</a></h4>
      <div><i class="icon icon-user"></i> Denis Koelewijn</div>
      <div><i class="icon icon-calendar"></i> 2010-06-02</div>
...
For this one, I kinda have to just point you at [Divio's Documentation System](https://documentation.divio.com/). The types are:
